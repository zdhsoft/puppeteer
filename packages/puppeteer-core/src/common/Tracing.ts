...
/**
 * The Tracing class exposes the tracing audit interface. @remarks You can use
 * `tracing.start` and `tracing.stop` to create a trace file which can be opened
 * in Chrome DevTools or {@link
...
export class Tracing {
   ...
   *
   * @remarks Only one trace can be active at a time per browser.
   *
