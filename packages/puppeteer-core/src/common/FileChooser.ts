 ...
 *
 * @remarks `FileChooser` instances are returned via the {@link
...
export class FileChooser {
  ...
  /**
   * Whether file chooser allow for {@link
   ...
   *
   * @param filePaths - If some of the `filePaths` are relative paths, then they
   * are resolved relative to the {@link
