...
export class NetworkManager extends EventEmitter {
  ...
  #onAuthRequired(event: Protocol.Fetch.AuthRequiredEvent): void {
    /**
     * TODO(jacktfranklin): This is defined in protocol.d.ts but not in an
     * easily referrable way - we should look at exposing it.
     */
   ...
   * Network.requestWillBeSent
   *
   * CDP may send multiple Fetch.requestPaused for the same
   * Network.requestWillBeSent.
   */
