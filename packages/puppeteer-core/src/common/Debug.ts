 ...
 *
 * @remarks If used in Node, it falls back to the {@link
 * https://www.npmjs.com/package/debug | debug module}. In the browser it uses
 * `console.log`.
 *
 ...
 * ```
 *
 * @param prefix - this will be prefixed to each log. @returns a function that
 * can be called to log to that debug channel.
 *
 * @internal
 */
