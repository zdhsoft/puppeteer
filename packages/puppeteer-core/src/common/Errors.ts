 ...
 * timeout.
 *
 * @remarks Example operations are {@link Page.waitForSelector |
 * page.waitForSelector} or {@link PuppeteerNode.launch | puppeteer.launch}.
 *
 * @public
 */
 ...
 *
 * @example An example of handling a timeout error:
 *
 * ```ts
 * try {
